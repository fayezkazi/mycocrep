		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Certificate of Conformity Report",
									"targetURL": "#mycocrepmycocrep-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mycocrepmycocrep-display": {
								"semanticObject": "mycocrepmycocrep",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mycoc.rep.mycocrep",
									"url": sap.ui.require.toUrl("mycoc/rep/mycocrep")
								}
							}
						}
					}
